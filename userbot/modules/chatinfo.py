...
async def info(event):
    await event.edit("`Analyzing the chat ...`")
...
async def get_chatinfo(event):
    ...
    try:
        ...
        try:
            ...
            await event.edit(
                "`This is a private channel / group or I don't have access to it.`"
            )
            return None
        except ChannelPublicGroupNaError:
            await event.edit("`Channel or supergroup does not exist`")
            return None
...
CMD_HELP.update(
    {
        "chatinfo": ".chatinfo [optional: <reply / tag / chat id / invitation link>]\
            \nUsage: Get information from a chat. Some of the information may be limited due to lack of permissions."
    }
)
